//Add Message - Allow Partial False
...
(function () {
    return {
        ...
        execute: function (log, agent, data) {
            ...
            objData1["parameters"] = [];
            objData1["parameters"].push({"param":"ID", "value":"SUBS4", "required":true});
            ...
            objData2["parameters"] = [];
            objData2["parameters"].push({"param":"ID", "value":"SUBS5", "required":true});
            ...
            objData2["parameters"].push({"param":"InvalidParameter", "value":true, "required":true});

// Subscription on Notification Retry - Retry Expiration
...
(function () {
    return {
        ...
        execute: function (log, agent, data) {
            ...
            objData1["parameters"] = [];
            objData1["parameters"].push({"param":"ID", "value":"SUBS7", "required":true});
            ...
            objData1["parameters"].push({"param":"NotifExpiration", "value":10, "required":true});

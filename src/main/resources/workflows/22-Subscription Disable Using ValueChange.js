// Subscription Disable Using ValueChange
...
(function () {
    return {
        ...
        execute: function (log, agent, data) {
            ...
            var objData1 = {};
            objData1["basePath"] = "Device.LocalAgent.Subscription.[ID==\"SUBS3\"].";
            objData1["updateParameters"] = [];
            objData1["updateParameters"].push({"param":"Enable", "value":false, "required":false});

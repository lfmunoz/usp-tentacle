// Asynchronous Operation Test Using Device.Firmware.Download
...
(function () {
    return {
        ...
        execute: function (log, agent, data) {
            ...
            objData1["parameters"] = [];
            objData1["parameters"].push({"param":"ID", "value":"SUBS10", "required":true});
            ...
            objData1["parameters"].push({"param":"ReferenceList", "value":"Device.LocalAgent.TransferComplete!", "required":true});
